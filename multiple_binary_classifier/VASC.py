...
# Select images with VASC
dfVASC = df[df["VASC"] == 1][["image", "VASC"]]
dfNotVASC = df[df["VASC"] == 0][["image", "VASC"]]

# Balance the dataset by undersampling
dfNotVASC = dfNotVASC.sample(frac=0.04, random_state=42)
df = pd.concat([dfVASC, dfNotVASC]).sample(frac=1, random_state=42)
