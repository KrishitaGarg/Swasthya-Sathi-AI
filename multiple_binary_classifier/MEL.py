...
# Select images with MEL
dfMEL = df[df["MEL"] == 1][["image", "MEL"]]
dfNotMEL = df[df["MEL"] == 0][["image", "MEL"]]

# Balance the dataset by undersampling
dfNotMEL = dfNotMEL.sample(frac=0.04, random_state=42)
df = pd.concat([dfMEL, dfNotMEL]).sample(frac=1, random_state=42)
